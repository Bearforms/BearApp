...
export function FormLogo({ logo, onLogoChange }: FormLogoProps) {
  ...
  return (
    <div className="relative">
      <div
        className={cn('relative', !logo && 'cursor-pointer')}
      ...
      >
        ...
        {logo ? (
          ...
          <div className="w-24 h-24 rounded-full border-4 border-white shadow-sm bg-neutral-50 hover:bg-neutral-100 transition-colors flex items-center justify-center">
