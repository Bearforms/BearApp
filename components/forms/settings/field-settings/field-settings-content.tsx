...
import { isContentField, isPageBreak, isRatingField } from './utils';
...
export function FieldSettings({ field, onFieldUpdate, fields }: FieldSettingsProps) {
  return (
    <div className="space-y-8">
      ...
      {!isContentField(field) && !isPageBreak(field) && !isRatingField(field) && (
